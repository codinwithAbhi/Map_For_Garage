            ...
            <MDBRow>
                    ...
                    >
                        <div className="d-flex flex-column ms-5">
                            ...
                            <div className="text-center">
                                ...
                                <h4 className="mt-1 mb-5 pb-1">Never Be Stranded Again – Find a Nearest Garage Instantly!</h4>
                            </div>
                            ...
                            <div className="d-flex flex-row align-items-center justify-content-center pb-4 mb-4">
                                ...
                                <NavLink to='registration'><MDBBtn outline className='mx-2' color='danger'> Sign Up  </MDBBtn></NavLink>
                            </div>
                ...
                <MDBCol col='6' className="mb-5">
                    ...
                    <motion.div
                        ...
                        transition={{ duration: 1, ease: "easeOut" }} n
                    >
